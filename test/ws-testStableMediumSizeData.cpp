 ...
 * @author haisheng.yhs
 * @description
 *      duplex send data from 123 to 400K
 *      last 30 minutes
...
int start_server( void *ptr ) {
    ...
    int result = system("rm -rf server.mediumSizeData.log; ./WsServerTestBase 0.0.0.0 8080 2>&1 | tee server.mediumSizeData.log");
...
int start_client( void *ptr ) {
    ...
    int result = system("rm -rf client.mediumSizeData.log; ./WsClientTestBaseNoEndMsg 127.0.0.1 8080 409600 50000 ! 2>&1 | tee client.mediumSizeData.log"); //409600 max
...
int start_client2( void *ptr ) {
    LOG_INFO("start client");
    int result = system("rm -rf client2.mediumSizeData.log; ./WsClientTestBaseNoEndMsg 127.0.0.1 8080 409600 50000 A 2>&1 | tee client2.mediumSizeData.log"); //409600 max
    LOG_INFO("client return %d", result);
    return result;
}
...
int start_client_end( void *ptr ) {
    ...
    int result = system("rm -rf clientEnd.mediumSizeData.log; ./WsClientTestSendEnd 127.0.0.1 8080 2>&1 | tee clientEnd.mediumSizeData.log");
...
int checkResult() {
    int result = 0;
    if (system("grep ERROR client.mediumSizeData.log client2.mediumSizeData.log") == 0) {
